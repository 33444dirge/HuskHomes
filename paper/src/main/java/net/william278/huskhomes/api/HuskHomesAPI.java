...
public class HuskHomesAPI extends BaseHuskHomesAPI {
     ...
     */
    @ApiStatus.Internal
    private HuskHomesAPI(@NotNull PaperHuskHomes plugin) {
        super(plugin);
    }
     ...
     */
    @ApiStatus.Internal
    public static void register(@NotNull PaperHuskHomes plugin) {
    ...
    public OnlineUser adaptUser(@NotNull Player player) {
        return ((PaperHuskHomes) plugin).getOnlineUser(player);
    }
    ...
    public org.bukkit.Location getLocation(@NotNull Position position) {
        return PaperHuskHomes.Adapter.adapt(position);
    }
    ...
    public Location adaptLocation(@NotNull org.bukkit.Location location) {
        return PaperHuskHomes.Adapter.adapt(location);
    }
