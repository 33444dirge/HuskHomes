...
public class BukkitCommand extends org.bukkit.command.Command {
    ...
    public BukkitCommand(@NotNull Command command, @NotNull PaperHuskHomes plugin) {
    ...
    @Nullable
    protected static Permission addPermission(@NotNull PaperHuskHomes plugin, @NotNull String node,
